...
Here's the resulting network generated by the above program (the results will very, since there is randomness involed):

<img alt=Network src=img/result.svg width=256 />
